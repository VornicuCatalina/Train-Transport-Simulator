...
void menu()
{
	...
	printf("[server] -----------> Este de forma o locatie sau introduceti \'-\' in caz ca le vreti pe toate\n");
	printf("[server] --> plecari (veti vedea ce trenuri pleaca in intervalul mai scurt sau egal de 1h)\n");
	printf("[server] -----------> Este de forma o locatie sau introduceti \'-\' in caz ca le vreti pe toate\n");
	printf("[server] --> modificari (veti putea modifica intarzierile la plecare, cat si estimarile la sosire)\n");
	printf("[server] -----------> Este de forma id_tren minute_intarziere sau introduceti \'-\' in caz ca nu exista ora estimativa sau introduceti \'-\' in caz ca nu este \n");
	printf("[server] -----------> Intarzierea e sub forma: <x> min mai <D|T> unde D este devreme si T tarziu\n");
	printf("[server] --> orar (Pentru orarul tuturor trenurilor)\n");
	printf("[server] -----------> Sau de forma orar x , unde x este o locatie care va fi verificata\n");
